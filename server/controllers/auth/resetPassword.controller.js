...
module.exports = (req, res, next) => {
    const { resetPasswordLink, newPassword} = req.body;             /* resetPasswordLink is available in the User schema */
                    ...
                    .json({
                        resetPasswordError: 'Expired link. Please request another password link'
                                                                            ...
                                                                            /* by elimination, it is an 'expired link' error
                                                                                ...
                                                                                resetPasswordLink (that has an expire date),
                                                                                & accountActivation controller works ok so far */
            }
